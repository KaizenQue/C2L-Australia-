    ...
    const renderDesktopView = () => (
        <div>
            ...
            <div className='absolute z-10 w-full h-full mt-[-60%]'>
                <div className="flex w-[1466.954px] h-[140px]  z-10 justify-end items-center gap-8 bg-[#C09F53] overflow-hidden relative mt-16">
    ...
    const renderMobileView = () => (
        <div className="w-full relative">
            ...
            <div className="w-full p-2 bg-gradient-to-br from-[#023437] to-[rgba(2,52,55,0.53)] backdrop-blur-sm mt-0 pb-10">
                <div className="w-full py-4 bg-[#C09F53] overflow-hidden absolute z-10 ">
                    <div className="flex whitespace-nowrap animate-marquee">
                        <div className="flex items-center">
                            <span className="text-white text-center font-['Playfair_Display'] text-3xl font-extrabold leading-none">
                                Get a free case review
                            </span>
                            <img src={Marquee} alt="Banner" className="h-12 w-12 object-cover ml-0" />
                        </div>
                    </div>
                </div>
                <form ref={formRef} onSubmit={handleSubmit} className='mb-10' >
                    <div className="space-y-6 pt-32 mb-10 p-5">
                        <TextField
                            id="firstName"
                            name="firstName"
                            label="First Name"
                    ...
                    <div className="mt-8 space-y-6 text-white">
                        ...
                        <div className="flex items-start mt-4">
                            ...
                            <label htmlFor="privacyConsent" className="ml-3 block text-white text-base text-left">
                                ...
                                <span className="block mt-2">
                                    I consent to be contacted by telephone, email, text message or mail.
                                </span>
                            </label>
